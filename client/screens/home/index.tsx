...
export default function HomeScreen() {
  ...
  }, [selectedProject, selectedWorkers, selectedDate, description, fetchWorkLogs, handleClearForm, workers, projects]);
  ...
  // 删除工时记录
  const handleDeleteWorkLog = useCallback(async (workLogId: number) => {
    Alert.alert(
      '确认删除',
      '确定要删除这条工时记录吗？',
      [
              ...
              workLogs.map(workLog => (
                <ThemedView key={workLog.id} level="default" style={styles.workLogCard}>
                  ...
                  <View style={styles.workLogFooter}>
                    ...
                    <TouchableOpacity onPress={() => handleDeleteWorkLog(workLog.id)}>
